...
##        if self.projetil.caixacolisao:pygame.draw.rect(screen,(255,0,0),self.projetil.caixacolisao,1)
    ...
    def criacaixagolpe(self,dtempo):
        ...
        LARGURA_SPRITE = 300
        COMPRIMENTO_BRACO = COMPRIMENTO_PERNA = 100
        if self.socando:
            if self.adversario.x > self.x:
                if self.abaixado:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,40)
                elif self.pulando:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,100)
                else:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,40)
            else:
                if self.abaixado:
                    self.caixagolpe = Rect(self.x-LARGURA_SPRITE,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,40)
                elif self.pulando:
                    self.caixagolpe = Rect(self.x-LARGURA_SPRITE,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,100)
                else:
                    self.caixagolpe = Rect(self.x-LARGURA_SPRITE,self.caixacorpo.top+COMPRIMENTO_BRACO,LARGURA_SPRITE,40)
        elif self.chutando:
            if self.adversario.x > self.x:
                if self.abaixado:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.bottom-100,LARGURA_SPRITE+COMPRIMENTO_PERNA,100)
                elif self.pulando:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.bottom-150,LARGURA_SPRITE-COMPRIMENTO_PERNA,150)
                else:
                    self.caixagolpe = Rect(self.x+self.caixacorpo.width,self.caixacorpo.bottom-150,LARGURA_SPRITE-COMPRIMENTO_PERNA,150)
            else:
                if self.abaixado:
                    self.caixagolpe = Rect(self.x-(LARGURA_SPRITE+COMPRIMENTO_PERNA),self.caixacorpo.bottom-100,LARGURA_SPRITE+COMPRIMENTO_PERNA,100)
                elif self.pulando:
