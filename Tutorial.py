...
class Tutorial(object):
    ...
    def render(self, screen):
        ...
        if self.configcontrole:
            ...
            screen.blit(self.font.render("Configurando Controles:", True, (self.cor, 0, 0)),
                        ((self.width / 2) - (self.font.size("Configurando Controles:")[0] / 2), self.height * 0.1))
            screen.blit(self.font.render("Pressione:", True, (self.cor, 0, 0)),
                        ((self.width / 2) - (self.font.size("Pressione:")[0] / 2), self.height * 0.4))

            listabotoes = []
            if self.configcontrole == 1:
                screen.blit(self.font.render("Jogador 1", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Jogador 1")[0] / 2), self.height * 0.2))
                listabotoes = self.botoesp1
            elif self.configcontrole == 2:
                screen.blit(self.font.render("Jogador 2", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Jogador 2")[0] / 2), self.height * 0.2))
                listabotoes = self.botoesp2

            if len(listabotoes) == 0:
                screen.blit(self.font.render("Cima", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Cima")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 1:
                screen.blit(self.font.render("Baixo", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Baixo")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 2:
                screen.blit(self.font.render("Esquerda", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Esquerda")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 3:
                screen.blit(self.font.render("Direita", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Direita")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 4:
                screen.blit(self.font.render("Soco", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Soco")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 5:
                screen.blit(self.font.render("Chute", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Chute")[0] / 2), self.height * 0.5))
            elif len(listabotoes) == 6:
                screen.blit(self.font.render("Especial", True, (self.cor, 0, 0)),
                            ((self.width / 2) - (self.font.size("Especial")[0] / 2), self.height * 0.5))
...
class Retrato(object):
    ...
    def __init__(self, nome, coords):
        ...
        self.somescolhejogador = pygame.mixer.Sound(
            os.path.join('.', 'assets', "Personagens", self.nome, "escolhe.wav"))
    ...
    def render(self, screen):
        ...
        screen.blit(self.font.render(self.nome, True, (155, 0, 0)),
                    (self.x + 45 - (self.font.size(self.nome)[0] / 2), self.y + 130))
    ...
    def seleciona(self, player):
        ...
        if player == 1:
            self.selecionadop1 = True
        else:
            self.selecionadop2 = True
    ...
    def escolhe(self, player):
        """ define o jogador de determinado numero como seletor do retrato """
        if player == 1:
            self.escolhidop1 = True
        else:
            self.escolhidop2 = True
